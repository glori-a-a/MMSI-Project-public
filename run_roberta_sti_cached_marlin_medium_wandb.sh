...
WANDB_PROJECT="${WANDB_PROJECT:-Roberta+marlin}"
WANDB_ENTITY="${WANDB_ENTITY:-}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-roberta_sti_keypoint_cached_marlin_youtube_medium_utt_v3}"
...
python train.py \
  --model_name "roberta_sti_keypoint_cached_marlin_youtube_medium_utt_v3" \
  --task "STI" \
  ...
  --checkpoint_save_dir "${PROJECT_ROOT}/checkpoints/roberta_sti_keypoint_cached_marlin_youtube_medium_utt_v3" \
