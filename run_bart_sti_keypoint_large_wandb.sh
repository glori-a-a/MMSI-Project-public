...
WANDB_PROJECT="${WANDB_PROJECT:-mmsi-bart-keypoint-large}"
WANDB_ENTITY="${WANDB_ENTITY:-}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-bart_sti_keypoint_youtube_large}"
...
python train.py \
  --model_name "bart_sti_keypoint_youtube_large" \
  --task "STI" \
  ...
  --checkpoint_save_dir "${PROJECT_ROOT}/checkpoints/bart_sti_keypoint_youtube_large" \
  --language_model "bart" \
  --text_pooling "mask" \
