...
ABLATION_ROOT="${PROJECT_ROOT}/masked_player_workspace"
...
MODEL_NAME="${MODEL_NAME:-masked_${TASK,,}_${DATASET}_vf${VISUAL_FILM_LAYERS}_ff${FUSION_FILM_LAYERS}_${FUSION_MODE}_${GRAPH_MODE}_${CLASSIFIER_MODE}_gl${GRAPH_LAYERS}_seed${SEED}_cl${CENTER_LOSS_WEIGHT}_sc${SUPCON_WEIGHT}_j${JEPA_WEIGHT}_jm${JEPA_MASK_COUNT}}"
