...
WANDB_PROJECT="${WANDB_PROJECT:-mmsi-gpt2-cached-vit-quick}"
WANDB_ENTITY="${WANDB_ENTITY:-}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-gpt2_sti_keypoint_cached_vit_youtube_quick}"
...
python train.py \
  --model_name "gpt2_sti_keypoint_cached_vit_youtube_quick" \
  --task "STI" \
  ...
  --checkpoint_save_dir "${PROJECT_ROOT}/checkpoints/gpt2_sti_keypoint_cached_vit_youtube_quick" \
  --language_model "gpt2" \
  --text_pooling "last" \
