...
MODEL_NAME="${MODEL_NAME:-ablation_${TASK,,}_${DATASET}_vf${VISUAL_FILM_LAYERS}_ff${FUSION_FILM_LAYERS}_${FUSION_MODE}_bt${BOTTLENECK_TOKENS}_bl${BOTTLENECK_FUSION_LAYERS}_gl${GRAPH_LAYERS}_cl${CENTER_LOSS_WEIGHT}_sc${SUPCON_WEIGHT}}"
