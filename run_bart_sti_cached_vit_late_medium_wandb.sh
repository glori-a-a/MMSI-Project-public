...
WANDB_PROJECT="${WANDB_PROJECT:-mmsi-bart-cached-vit-late-medium}"
WANDB_ENTITY="${WANDB_ENTITY:-}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-bart_sti_keypoint_cached_vit_late_youtube_medium}"
...
python train.py \
  --model_name "bart_sti_keypoint_cached_vit_late_youtube_medium" \
  --task "STI" \
  ...
  --checkpoint_save_dir "${PROJECT_ROOT}/checkpoints/bart_sti_keypoint_cached_vit_late_youtube_medium" \
  --language_model "bart" \
  --text_pooling "mask" \
