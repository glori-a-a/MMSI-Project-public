...
WANDB_RUN_NAME="${WANDB_RUN_NAME:-roberta_sti_keypoint_cached_vit_youtube_full_utt_v3}"
...
python train.py \
  --model_name "roberta_sti_keypoint_cached_vit_youtube_full_utt_v3" \
  --task "STI" \
  ...
  --checkpoint_save_dir "${PROJECT_ROOT}/checkpoints/roberta_sti_keypoint_cached_vit_youtube_full_utt_v3" \
