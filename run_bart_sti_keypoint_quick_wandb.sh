...
WANDB_PROJECT="${WANDB_PROJECT:-mmsi-bart-keypoint-quick}"
WANDB_ENTITY="${WANDB_ENTITY:-}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-bart_sti_keypoint_youtube_quick}"
...
python train.py \
  --model_name "bart_sti_keypoint_youtube_quick" \
  --task "STI" \
  ...
  --checkpoint_save_dir "${PROJECT_ROOT}/checkpoints/bart_sti_keypoint_youtube_quick" \
  --language_model "bart" \
  --text_pooling "mask" \
